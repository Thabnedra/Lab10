...
struct Graph{
    ...
    void print(){
        ...
        for(int i=0;i<n;i++){
            cout<<"Node value "<<nodes[i].label<<endl; // select Node value
            cout<<"Neighbours"<<endl; 
            for(int NeigVal:nodes[i].neighbours){ // NeigVal mean neighbour value of node
                cout<<NeigVal<<" "; // print neighbour value
            }
            cout<<endl;
        }
    }
